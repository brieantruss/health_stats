...
with DAG(
    dag_id='health_stats_heart_rate',
    ...
    RAW_FILES_DIR = "/home/modulo/development/health_stats/raw_files/heart_rate"
    PROCESSED_FILES_DIR = "/home/modulo/development/health_stats/processed_files/heart_rate"
    ...
    extract_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/extract_heart_rate.py "{GCS_KEY_FILE}" "{RAW_FILES_DIR}"',
    ...
    transform_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/transform_heart_rate.py "{RAW_FILES_DIR}" "{PROCESSED_FILES_DIR}"',
    )
    ...
    load_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/load_heart_rate.py "{PROCESSED_FILES_DIR}"',
    )
