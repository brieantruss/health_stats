...
with DAG(
    ...
    RAW_FILES_DIR = "/home/modulo/development/health_stats/raw_files/cycling"
    PROCESSED_FILES_DIR = "/home/modulo/development/health_stats/processed_files/cycling"
    ...
    extract_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/extract_cycling.py "{GCS_KEY_FILE}" "{RAW_FILES_DIR}"',
    ...
    transform_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/transform_cycling.py "{RAW_FILES_DIR}" "{PROCESSED_FILES_DIR}"',
    )
    ...
    load_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/load_cycling.py "{PROCESSED_FILES_DIR}"',
    )
