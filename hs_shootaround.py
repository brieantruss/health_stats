...
with DAG(
    dag_id='health_stats_shootaround',
    ...
    RAW_FILES_DIR = "/home/modulo/development/health_stats/raw_files/shootaround"
    PROCESSED_FILES_DIR = "/home/modulo/development/health_stats/processed_files/shootaround"
    ...
    extract_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/extract_shootaround.py "{GCS_KEY_FILE}" "{RAW_FILES_DIR}"',
    ...
    transform_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/transform_shootaround.py "{RAW_FILES_DIR}" "{PROCESSED_FILES_DIR}"',
    )
    ...
    load_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/load_shootaround.py "{PROCESSED_FILES_DIR}"',
    )
