...
API_BASE_URL = "http://192.168.0.110:5001" # Ensure this is correct

# Allowed exercises for input validation and display (existing)
ALLOWED_EXERCISES = [
    'adductor_stretch', 'body_weight_squats', 'bridge_stretch', 'butterfly_stretch',
    'calf_raises_two_leg', 'calf_stretch', 'chest_stretch', 'crunches', 'dips',
    'dorsal_raise', 'downward_dog_stretch', 'hamstring_stretch', 'heel_grab_stretch',
    'inverted_rows', 'kapotasana_stretch', 'kneeling_hip_flexor_stretch', 'leg_raises',
    ...
    with st.form("add_diet_form"):
        ...
        with col_diet1:
            if food_descriptions:
                ...
                st.warning("could not load food descriptions. please ensure your api is running and the 'main_food_descriptions' table has data.") # Lowercase messages
                selected_item = None
