...
DRIVE_FOLDER_ID = '1ZAXfjJQYxsq_pgxutXFF2YkawdNNunVJ'  # Your Google Drive folder ID
...
def move_files_local(service_account_file, local_save_path):
    ...
    filename_pattern = re.compile(r"Steps \d{4}\.\d{2}\.\d{2}( \d{2}\.\d{2})? Samsung Health\.csv")
