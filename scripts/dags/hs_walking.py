...
with DAG(
    ...
    RAW_FILES_DIR = "/home/modulo/development/health_stats/raw_files/walking"
    PROCESSED_FILES_DIR = "/home/modulo/development/health_stats/processed_files/walking"
    ...
    extract_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/extract_walking.py "{GCS_KEY_FILE}" "{RAW_FILES_DIR}"',
    ...
    transform_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/transform_walking.py "{RAW_FILES_DIR}" "{PROCESSED_FILES_DIR}"',
    )
    ...
    load_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/load_walking.py "{PROCESSED_FILES_DIR}"',
    )
